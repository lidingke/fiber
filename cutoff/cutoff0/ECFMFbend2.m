...
% ECFMFbend.m
%
% Model exported on Dec 29 2015, 10:41 by COMSOL 5.1.0.136.
...
model.geom('geom2').feature('c4').active(false);
model.geom('geom2').feature('c4').label('clad');
...
model.mesh('mesh2').feature('ftri1').feature('size1').selection.set([7]);
...
model.view('view2').axis.set('abstractviewxscale', '4.0441750570607837E-7');
model.view('view2').axis.set('ymin', '-3.0937499104766175E-5');
model.view('view2').axis.set('xmax', '0.14012131094932556');
model.view('view2').axis.set('abstractviewyscale', '4.0441176452077343E-7');
model.view('view2').axis.set('abstractviewbratio', '0.28663793206214905');
model.view('view2').axis.set('abstractviewtratio', '-0.28663793206214905');
model.view('view2').axis.set('abstractviewrratio', '0.2638531029224396');
model.view('view2').axis.set('xmin', '0.13987866044044495');
model.view('view2').axis.set('abstractviewlratio', '-0.047680411487817764');
model.view('view2').axis.set('ymax', '3.0937499104766175E-5');
...
model.result.table('tbl6').comments('n_eff_geometry 1 (ewfd2.neff)');
model.result.table('tbl7').comments('BlossdBM (54.5474*abs(imag(ewfd2.neff))/wl/R)');
...
model.result.numerical('gev9').set('data', 'dset3');
model.result.numerical('gev9').set('probetag', 'none');
...
model.study('std2').feature('mode').set('shift', 'coreBendNeff');

model.sol('sol2').attach('std2');
model.sol('sol2').feature('e1').set('neigs', '2');
model.sol('sol2').feature('e1').set('shift', 'coreBendNeff');
...
model.result.numerical('gev8').set('table', 'tbl7');
model.result.numerical('gev8').set('unit', '1/m^2');
model.result.numerical('gev8').set('descractive', true);
model.result.numerical('gev9').label('n_eff_geometry 1');
model.result.numerical('gev9').set('expr', 'ewfd2.neff');
model.result.numerical('gev9').set('unit', '1');
model.result.numerical('gev9').set('descr', 'Effective mode index');
model.result.numerical('gev9').set('table', 'tbl6');
...
model.result('pg2').feature('arws1').set('scale', '1.670775425514128E-7');
