...
% ECFMFstraight1.m
%
% Model exported on Dec 28 2015, 20:22 by COMSOL 5.1.0.136.
...
model.view('view1').axis.set('xmax', '6.91748718963936E-5');
...
model.view('view1').axis.set('xmin', '-6.91748718963936E-5');
...
model.result('pg1').feature('arws1').set('scale', '9.5801866363662E-5');
